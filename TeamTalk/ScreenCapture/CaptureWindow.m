...
- (void)onOK
{
    ...
    //[imageData writeToFile:@"/Users/jianqingdu/Work/cocoa/test.jpg" atomically:YES];
    //发布截图确定事件.
//    [getDDScreenCaptureModule() uiAsyncNotify:MKN_DDSCREENCAPTUREMODULE_OK userInfo:nil];
    [self orderOut:nil];
}
