...
@class DDHttpServer,DDTokenManager,DDMsgServer,DDTcpServer,DDLoginServer,UserEntity;
 ...
 *  @param password 密码
 */
- (void)loginWithUsername:(NSString*)name password:(NSString*)password success:(void(^)(UserEntity* user))success failure:(void(^)(NSString* error))failure;
