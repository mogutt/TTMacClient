...
@class DDUserDataWindowController,UserEntity,DDUserDataModel,DDUserInfoPanel;
/**
 *  管理显示个人资料
 */
 ...
 */
- (void)showUser:(UserEntity*)user forContext:(id)sender;

- (void)showUserForBang:(UserEntity*)user context:(id)sender;
