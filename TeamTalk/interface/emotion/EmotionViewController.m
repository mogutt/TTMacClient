...
@implementation EmotionViewController {
    ...
    DDChattingViewController *chattingViewController;
}
...
- (void)awakeFromNib
{
//    [_defaultTableView setDataSource:self];
//    [_defaultTableView setDelegate:self];
//    
//    [_moodTableView setDataSource:self];
//    [_moodTableView setDelegate:self];
//    
//    [_leisureTableView setDataSource:self];
//    [_leisureTableView setDelegate:self];
    [_yayaTableView setDataSource:self];
    [_yayaTableView setDelegate:self];
//    [_jokeTableView setDataSource:self];
//    [_jokeTableView setDelegate:self];
...
{
    if (chatViewController != chattingViewController) {
        chattingViewController = chatViewController;
    }
}
...
{
    [popover close];
    [chattingViewController emotionSelected:[cellView emotionFile]];
}
...
- (NSView *)tableView:(NSTableView *)tableView viewForTableColumn:(NSTableColumn *)tableColumn row:(NSInteger)row
{
    ...
    if (index <= max_offset[tabIndex]) {
        ...
        [cellView setEmotionViewController:self];
    }
...
-(void)showEmotionPreview:(EmotionCellView *)cell
{
    ...
    [self.emotionPreviewBG setHidden:NO];
     ...
     NSString *path = [[NSBundle mainBundle] pathForResource:[cell emotionFile] ofType:nil];
