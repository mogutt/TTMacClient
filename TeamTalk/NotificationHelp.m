...
NSString* const notificationUserReloginSuccess = @"Notification_user_relogin_success";
...
NSString* const notificationUserInitiativeOffline = @"Notification_user_initiative_Offline";
